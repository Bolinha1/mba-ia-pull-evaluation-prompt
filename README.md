...
| F1-Score | ~0.48 | **0.81** | ✓ Aprovado |
| Clarity | ~0.50 | **0.89** | ✓ Aprovado |
| Precision | ~0.46 | **0.89** | ✓ Aprovado |

**Média geral (v2): 0.8658** — todas as 5 métricas acima de 0.80.
...
Resultado: F1-Score subiu de 0.78/0.79 para **0.81**, aprovando em todas as 5 métricas na iteração seguinte.
